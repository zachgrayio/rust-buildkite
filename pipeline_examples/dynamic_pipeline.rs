//! Example: Building a Buildkite pipeline dynamically using the generated types
//!
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Build a multi-command step with a key for dependencies
    ...
    // Use the simple string wait step form
    let wait_step = StringWaitStep::Wait;
    ...
    // Build a deploy step that depends on tests
