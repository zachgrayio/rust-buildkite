...
async fn test_builds_cancel() {
    ...
    Mock::given(method("PUT"))
        ...
        .respond_with(common::json_response(
    ...
    let client = Client::builder("test-token")
        .http_client(common::mock_client())
...
async fn test_builds_list() {
    ...
    Mock::given(method("GET"))
        .and(path("/v2/builds"))
        .respond_with(common::json_response(r#"[{"id":"123"},{"id":"1234"}]"#))
        .mount(&mock_server)
        .await;
...
async fn test_builds_get() {
    ...
    Mock::given(method("GET"))
        ...
        .respond_with(common::json_response(r#"{"id":"123"}"#))
        .mount(&mock_server)
        .await;
